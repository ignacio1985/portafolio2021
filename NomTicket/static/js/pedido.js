...
function guardarPedido() {
    ...
    //console.log(VALOR);
    var COMENTARIO = "empleado";
    var CANTIDAD =localStorage.getItem('CANTIDAD');
    //console.log(CANTIDAD);
    var FK_CODIGO_EMP_ID = document.querySelector('#codigo_emp').value;
    //console.log(FK_CODIGO_EMP_ID);
    var FK_TIPO_TICKET_ID = 2;
    ...
    for (i = 0; i < orders.length; i++) {
        console.log('el indice: '+i+'hay este valor: '+orders[i])
        ...
        input_producto.cod= orders[i][4]+ "-" + i;
        console.log('si:',input_producto.cod)
